...
import com.shopping.foundation.service.impl.AreaServiceImpl;
...
public class StoreManageAction {
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂列表", value = "/admin/store_list.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂添加1", value = "/admin/store_add.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂添加2", value = "/admin/store_new.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
...
//			mv.addObject("scs", scs);
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂编辑", value = "/admin/store_edit.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
	@RequestMapping({ "/admin/store_edit.htm" })
	public @ResponseBody ModelAndView store_edit(HttpServletRequest request,
		...
		if ((id != null) && (!id.equals(""))) {
			...
			if (store.getBank_area_id() != null) {
				Area bank_area = this.areaService.getObjById(store.getBank_area_id());
				mv.addObject("bank_area_info",this.areaManageTools.generic_area_info(bank_area));
			}
		}
		return mv;
	}

	@SecurityMapping(display = false, rsequence = 0, title = "工厂保存", value = "/admin/store_save.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
	...
	public ModelAndView store_save(HttpServletRequest request,
			...
			String currentPage, String cmd, String list_url, String add_url, String userName, String password)
			throws Exception {
		WebForm wf = new WebForm();
		Store store = null;
		//依据主键操作实体
...
//			this.userService.update(user);
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂删除", value = "/admin/store_del.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
...
//					store.getUser().setStore(null);
					...
					String sql = "delete from shopping_user where store_id="+id;
					String sql2 = "SET FOREIGN_KEY_CHECKS = 0;";
					String sql3 = "SET FOREIGN_KEY_CHECKS = 1;";
					storeService.executeNativeSQL(sql2);
					int result = storeService.executeNativeSQL(sql);
					storeService.executeNativeSQL(sql3);
...
//				send_site_msg(request, "msg_toseller_goods_delete_by_admin_notify", store);
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂AJAX更新", value = "/admin/store_ajax.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
...
//		}
	...
	@SecurityMapping(display = false, rsequence = 0, title = "卖家信用", value = "/admin/store_base.htm*", rtype = "admin", rname = "基本设置", rcode = "admin_store_base", rgroup = "工厂")
	...
	@SecurityMapping(display = false, rsequence = 0, title = "卖家信用保存", value = "/admin/store_set_save.htm*", rtype = "admin", rname = "基本设置", rcode = "admin_store_base", rgroup = "工厂")
	...
	public ModelAndView store_set_save(HttpServletRequest request,
		...
		mv.addObject("list_url", list_url);
		mv.addObject("op_title", "保存工厂设置成功");
		return mv;
	}

	@SecurityMapping(display = false, rsequence = 0, title = "工厂模板", value = "/admin/store_template.htm*", rtype = "admin", rname = "工厂模板", rcode = "admin_store_template", rgroup = "工厂")
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂模板增加", value = "/admin/store_template_add.htm*", rtype = "admin", rname = "工厂模板", rcode = "admin_store_template", rgroup = "工厂")
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂模板保存", value = "/admin/store_template_save.htm*", rtype = "admin", rname = "工厂模板", rcode = "admin_store_template", rgroup = "工厂")
	...
	public ModelAndView store_template_save(HttpServletRequest request,
		...
		if (id.equals(""))
			...
			this.configService.update(sc);
		mv.addObject("list_url", list_url);
		mv.addObject("op_title", "工厂模板设置成功");
		return mv;
	}

	@SecurityMapping(display = false, rsequence = 0, title = "工厂升级列表", value = "/admin/store_gradelog_list.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂升级编辑", value = "/admin/store_gradelog_edit.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂升级保存", value = "/admin/store_gradelog_save.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
	...
	@SecurityMapping(display = false, rsequence = 0, title = "工厂升级日志查看", value = "/admin/store_gradelog_view.htm*", rtype = "admin", rname = "工厂管理", rcode = "admin_store_set", rgroup = "工厂")
