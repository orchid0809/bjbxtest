...
//     qo.addQuery("obj.goods_status", new SysMap("goods_status", Integer.valueOf(2)), "=");
     ...
     Integer[] status = {2,5};
     Set<Integer> ids = goodsStatusSet(status);
     paras.put("ids", ids);
     qo.addQuery("obj.goods_status in (:ids)", paras);
    ...
    * @return
    */
   @SecurityMapping(display = false, rsequence = 0, title="待销售商品列表", value="/admin/goods_stay_sale.htm*", rtype="admin", rname="商品管理", rcode="admin_goods", rgroup="商品")
   @RequestMapping({"/admin/goods_stay_sale.htm"})
   public ModelAndView goods_stay_sale(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType)
   {
     ModelAndView mv = new JModelAndView("admin/blue/goods_stay_sale.html", 
       this.configService.getSysConfig(), this.userConfigService
       .getUserConfig(), 0, request, response);
     String url = this.configService.getSysConfig().getAddress();
     if ((url == null) || (url.equals(""))) {
    ...
    /* qo.addQuery("obj.goods_status", new SysMap("goods_status", Integer.valueOf(2)), "<");*/
     Map paras = new HashMap();
     Integer[] status = {0,1,4};
     Set<Integer> ids = goodsStatusSet(status);
     paras.put("ids", ids);
     qo.addQuery("obj.goods_status in (:ids)", paras);
     IPageList pList = this.goodsService.list(qo);
     CommUtil.saveIPageList2ModelAndView(url + "/admin/goods_stay_sale.htm", "", 
       params, pList, mv);
     List gbs = this.goodsBrandService.query(
       "select obj from GoodsBrand obj order by obj.sequence asc", 
       null, -1, -1);
    ...
    * @return
    */
   @SecurityMapping(display = false, rsequence = 0, title="商品审核列表", value="/admin/goods_review.htm*", rtype="admin", rname="商品管理", rcode="admin_goods", rgroup="商品")
   @RequestMapping({"/admin/goods_review.htm"})
   public ModelAndView goods_review(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType)
   {
     ModelAndView mv = new JModelAndView("admin/blue/goods_review.html", 
       this.configService.getSysConfig(), this.userConfigService
       .getUserConfig(), 0, request, response);
     String url = this.configService.getSysConfig().getAddress();
     if ((url == null) || (url.equals(""))) {
     ...
     WebForm wf = new WebForm();
     wf.toQueryPo(request, qo, Goods.class, mv);
     qo.addQuery("obj.goods_status", new SysMap("goods_status", Integer.valueOf(3)), "=");
     IPageList pList = this.goodsService.list(qo);
     CommUtil.saveIPageList2ModelAndView(url + "/admin/goods_review.htm", "", 
       params, pList, mv);
     List gbs = this.goodsBrandService.query(
       "select obj from GoodsBrand obj order by obj.sequence asc", 
       null, -1, -1);
   ...
   @SecurityMapping(display = false, rsequence = 0, title="商品审核", value="/admin/goods_review_pass.htm*", rtype="admin", rname="商品管理", rcode="admin_goods", rgroup="商品")
   @RequestMapping({"/admin/goods_review_pass.htm"})
   public String goods_review_pass(HttpServletRequest request, HttpServletResponse response, String id,String status)
   {
	 Goods goods  = this.goodsService.getObjById(Long.valueOf(Long.parseLong(id)));
	 goods.setGoods_status(Integer.valueOf(Integer.parseInt(status)));
	 this.goodsService.update(goods);
     ModelAndView mv = new JModelAndView("admin/blue/goods_review.html", 
       this.configService.getSysConfig(), this.userConfigService
       .getUserConfig(), 0, request, response);
     
     return "redirect:goods_review.htm";
   }
    ...
    * @return
    */
   @SecurityMapping(display = false, rsequence = 0, title = "商品上下架", value = "/admin/goods_sale.htm*", rtype = "seller", rname = "商品上下架", rcode = "goods_sale_seller", rgroup = "商品管理")
	@RequestMapping({ "/admin/goods_sale.htm" })
	public String goods_sale(HttpServletRequest request,
			HttpServletResponse response, String mulitId) {
		String url = "/admin/goods_stay_sale.htm";
		...
		for (String id : ids) {
			if (!id.equals("")) {
				...
				int goods_status = (goods.getGoods_status() == 1 || goods.getGoods_status() == 0)? 2 : 1;
    ...
    * @return
    */
   @SecurityMapping(display = false, rsequence = 0, title = "商品缺货", value = "/admin/goods_stockout.htm*", rtype = "seller", rname = "商品缺货", rcode = "goods_sale_seller", rgroup = "商品管理")
	@RequestMapping({ "/admin/goods_stockout.htm" })
	public String goods_stockout(HttpServletRequest request,
			HttpServletResponse response, String mulitId) {
		String url = "/admin/goods_list.htm";
		String[] ids = mulitId.split(",");
		for (String id : ids) {
			if (!id.equals("")) {
				Goods goods = this.goodsService.getObjById(Long.valueOf(Long
    ...
    * @return
    */
   	@SecurityMapping(display = false, rsequence = 0, title = "商品删除", value = "/admin/goods_del.htm*", rtype = "admin", rname = "商品删除", rcode = "goods_del_seller", rgroup = "商品管理")
	...
	public String goods_del(HttpServletRequest request,
		...
		String url = "/admin/goods_list.htm";
		if (CommUtil.null2String(op).equals("stay")) {
			url = "/admin/goods_stay_sale.htm";
		}
		if (CommUtil.null2String(op).equals("review")) {
			url = "/admin/goods_review.htm";
		}
		String[] ids = mulitId.split(",");
		for (String id : ids) {
			if (!id.equals("")) {
   ...
   private Set<Integer> goodsStatusSet(Integer...integers){
	   Set<Integer> statusSet = new HashSet<Integer>();
	   for(Integer status :integers){
