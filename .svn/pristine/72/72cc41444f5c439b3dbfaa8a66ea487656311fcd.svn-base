 ...
 * 
 * <p>
 * Description: 表单对象和POJO转换类，该类可以将表单对象转换为POJO，也可以将查询表单转为查询对象QueryObject
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * Company: xShop信息科技有限公司 www.xShop.com
 * </p>
 * 
 * @author Echo
 * 
				...
				while (keys.hasNext()) {
					...
					if (key.equals(propertys[i].getName())) {
						...
						lock = (Lock) propertys[i].getWriteMethod()
								.getAnnotation(Lock.class);// 获取set方法是否有Lock注解
